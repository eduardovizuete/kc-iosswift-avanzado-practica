...
extension CoreBookTag {
    
    class func fetchRequestOrderedByName() -> NSFetchRequest<CoreBookTag> {
        
        let fetchRequest: NSFetchRequest<CoreBookTag> = CoreBookTag.fetchRequest()
    ...
    class func uniqueObjectWithValue(name: String, context: NSManagedObjectContext) -> CoreBookTag? {
